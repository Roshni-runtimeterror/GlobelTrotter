...
const DB_FILE = path.join(__dirname, 'globetrotter_db.json');
  ...
  trips: [
    {
      ...
      status: "upcoming",
      targetBudget: 120000,
      categoriesBudget: { transport: 35000, stay: 45000, activities: 22000, meals: 18000 },
      itinerary: [
        {
          day: 1,
    ...
    },
    {
      ...
      status: "upcoming",
      targetBudget: 95000,
      categoriesBudget: { transport: 24000, stay: 42000, activities: 15000, meals: 14000 },
      itinerary: [
        {
          day: 1,
